...
import { Product, ProductCollection, BlogPost, Category, MerchandisingCollection, Promotion } from "./types";
...
export const INITIAL_CATEGORIES: Category[] = [
  {
    ...
    banner: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1479064555552-3ef4979f8908?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1542272604-780c36856842?auto=format&fit=crop&w=1200&q=80",
...
export const INITIAL_PRODUCTS: Product[] = [
  // === SHIRTS ===
  {
    id: "sky-blue-premium-linen-shirt",
    name: "Sky Blue Premium Linen Shirt",
    slug: "sky-blue-premium-linen-shirt",
    price: 899,
    originalPrice: 1999,
    collection: ProductCollection.SHIRTS,
    category: "Premium Linen Shirts",
    images: [
      ...
      "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/shirts/clinza%20linen%20skyblue%20shirt%20(5).png",
      "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/shirts/clinza%20linen%20skyblue%20shirt%20(6).png",
      "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/shirts/clinza%20linen%20skyblue%20shirt%20(1).png"
    ],
    hoverImage: "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/shirts/clinza%20linen%20skyblue%20shirt%20(3).png",
    colors: [
      {
        name: "Sky Blue",
        hex: "#8DBEF8"
    ...
    rating: 4.8,
    reviews: [],
    shortDescription: "Premium sky blue bio-washed linen shirt crafted for everyday elegance. Lightweight, breathable, wrinkle-soft finish with a modern tailored silhouette suitable for office, travel, brunch, and evening wear.",
    description: "Experience refined everyday luxury with the Clinza Sky Blue Premium Linen Shirt.\n\nCrafted from premium bio-washed linen, this shirt delivers exceptional softness, breathable comfort, and a naturally elegant drape.\n\nThe versatile sky blue shade pairs perfectly with white, beige, grey, navy, or black trousers.\n\nDesigned with a regular comfort fit, premium stitching, reinforced construction, and premium buttons, it is ideal for office wear, vacations, casual outings, and smart occasions.",
    fabric: "100% Premium Bio-Washed Linen",
    fit: "Regular Comfort Fit",
    sleeve: "Full Sleeve",
    countryOfOrigin: "India",
    specifications: [
      { label: "Fabric Blend", value: "100% Premium Bio-Washed Linen" },
      ...
      { label: "Occasion", value: "Office, Casual, Smart Casual" },
      { label: "Care", value: "Machine Wash Cold" }
    ],
    aPlusContent: {
      title: "CLINZA Premium Linen Collection",
      description: "Premium European-inspired bio-washed linen engineered for breathable comfort and timeless elegance.",
      features: [
        { icon: "🌿", title: "Premium Linen", description: "Made using premium bio-washed linen." },
        { icon: "☁️", title: "Breathable Comfort", description: "Keeps you cool throughout the day." },
        { icon: "✂️", title: "Modern Tailoring", description: "Regular comfort fit with premium stitching." },
        { icon: "🧵", title: "Luxury Finish", description: "Crafted for long-lasting durability and elegance." }
      ]
    },
    isTrending: true,
    isNewArrival: true,
    demandBadge: "Best Seller",
    seoTitle: "Sky Blue Premium Linen Shirt | CLINZA Luxury",
    metaDescription: "Buy the CLINZA Sky Blue Premium Linen Shirt made from premium bio-washed linen. Lightweight, breathable and perfect for office, casual and smart occasions.",
    seoKeywords: "sky blue linen shirt, premium linen shirt, men's linen shirt, linen shirt india, bio washed linen, premium mens shirt, blue shirt, CLINZA"
  },
  {
  ...
  // === JEANS (8 to 12) ===
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1542272604-780c36856f66?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    category: "Luxury Footwear",
    images: [
      "https://images.unsplash.com/photo-1582845844300-6697337a6b4a?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?auto=format&fit=crop&w=800&q=80"
    ],
...
3. **Slight Creases are Premium**: Embrace the organic wrinkles. An authentic, lived-in linen crease is a badge of organic fabric authenticity. If a flat press is desired, steam or iron while the fabric is slightly damp.
    `,
    coverImage: "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/slider/combo%20collection%20linen%20set.png",
    category: "Style Guide",
    publishedAt: "2026-06-05T08:30:00Z",
    author: {
      name: "Alessandro Vanti",
      avatarUrl: "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/slider/combo%20collection%20linen%20set.png",
...
export const INITIAL_MERCHANDISING_COLLECTIONS: MerchandisingCollection[] = [
  {
    id: "merch-new-arrivals",
    name: "New Arrivals",
    slug: "new-arrivals",
    description: "Freshly dropped luxury resortwear and seasonal tailored essentials",
    banner: "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 1,
    active: true,
    productIds: []
  },
  {
    id: "merch-trending",
    name: "Trending Leaderboard",
    slug: "trending",
    description: "Top ranked and highly demanded wardrobe favorites right now",
    banner: "https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 2,
    active: true,
    productIds: []
  },
  {
    id: "merch-best-sellers",
    name: "Best Sellers",
    slug: "best-sellers",
    description: "Most loved signature garments rated 4.8+ by over 10,000 customers",
    banner: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 3,
    active: true,
    productIds: []
  },
  {
    id: "merch-summer-collection",
    name: "Summer Collection",
    slug: "summer-collection",
    description: "Lightweight, breathable 100% European linen and organic cotton shirts",
  ...
  {
    id: "merch-limited-edition",
    name: "Limited Edition",
    slug: "limited-edition",
    description: "Small batch handcrafted garments with rare fabrics and mother of pearl buttons",
    banner: "https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 5,
    active: true,
    productIds: []
  },
  {
    ...
    name: "Combo Offers",
    slug: "combos",
    description: "Curated shirt and trouser co-ord pairings with up to 30% bundle savings",
    banner: "https://images.unsplash.com/photo-1516257984-b1b4d707412e?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 6,
    active: true,
    productIds: []
  },
  {
    id: "merch-buy-2-get-1",
    name: "Buy 2 Get 1",
    slug: "buy-2-get-1",
    description: "Add any 3 luxury garments to cart and get the 3rd item free",
  ...
  {
    id: "merch-ongoing-offers",
    name: "Ongoing Offers",
    slug: "ongoing-offers",
    description: "Exclusive promotional coupons and seasonal discount deals",
    banner: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 8,
    active: true,
    productIds: []
  },
  {
    ...
    slug: "featured",
    description: "Handpicked flagship products highlighted by our head stylists",
    banner: "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=1600&q=80",
    displayOrder: 9,
    active: true,
    productIds: []
...
export const INITIAL_PROMOTIONS: Promotion[] = [
  {
    ...
    name: "Grand Festive Upgrade",
    banner: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=1600&q=80",
    offerType: "Percentage Discount",
    startDate: "2026-01-01",
    endDate: "2026-12-31",
    active: true,
    landingPage: "/collections/all",
    description: "FLAT 30% Off across all luxury collections using code FESTIVE30",
    discountValue: "30% OFF",
    displayOrder: 1,
    productIds: []
  },
  {
    id: "promo-combo-savings",
    name: "Luxury Combo Wardrobe Set",
    banner: "https://images.unsplash.com/photo-1516257984-b1b4d707412e?auto=format&fit=crop&w=1600&q=80",
    offerType: "Bundle Deal",
    startDate: "2026-01-01",
    endDate: "2026-12-31",
    active: true,
    landingPage: "/collections/combos",
    description: "Buy Shirt + Jeans Combo for flat ₹3,499",
    discountValue: "SAVE ₹1,500",
    displayOrder: 2,
    productIds: []
  },
  {
    id: "promo-buy2get1",
    name: "Buy 2 Shirts Get 1 Free",
    banner: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1600&q=80",
    offerType: "Buy X Get Y",
    startDate: "2026-01-01",
    endDate: "2026-12-31",
    active: true,
    landingPage: "/collections/shirts",
    description: "Add 3 shirts to cart, 3rd shirt becomes free instantly",
    discountValue: "3RD ITEM FREE",
    displayOrder: 3,
    productIds: []
  }
];
