  ...
  useEffect(() => {
    ...
    if (cached) {
      ...
      const initial: MediaAsset[] = [
        { id: "ast-1", name: "Italian Linen Cream Cover", url: "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&q=80&w=800", type: "image", size: "320 KB", createdAt: "2026-06-03", folder: "collections" },
        { id: "ast-2", name: "Classic Italian Linen Model Roll", url: "https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&q=80&w=800", type: "image", size: "280 KB", createdAt: "2026-06-04", folder: "homepage" },
        { id: "ast-3", name: "Indigo Selvedge Shuttle Loom Close", url: "https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&q=80&w=800", type: "image", size: "1.2 MB", createdAt: "2026-06-05", folder: "products" },
        { id: "ast-4", name: "Luxury Resort Wear Co-ord Shoot", url: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800", type: "image", size: "480 KB", createdAt: "2026-06-05", folder: "blogs" }
      ];
      setAssets(initial);
