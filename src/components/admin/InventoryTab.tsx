                      ...
                      <tr key={p.id} className="hover:bg-zinc-50/60 transition">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-3">
                            <img src={p.images?.[0] || "https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&q=80&w=100"} alt="" className="h-10 w-8 object-cover rounded border border-zinc-200 bg-zinc-100" />
                            <div>
