...
export const DEFAULT_WHATSAPP_TEMPLATES: WhatsAppAutomationConfig[] = [
  {
    ...
    buttons: [
      { type: "URL", text: "Shop New Arrivals", value: "https://www.clinza.in/collections/new-arrivals" },
  ...
  },
  {
    ...
    buttons: [
      { type: "URL", text: "Easy Returns / Exchanges", value: "https://www.clinza.in/returns" },
  ...
  },
  {
    ...
    buttons: [
      ...
      { type: "URL", text: "Pay Online & Save ₹100", value: "https://www.clinza.in/pay-online?order={{Order_Number}}" }
    ],
    category: "UTILITY",
    updatedAt: new Date().toISOString()
  },
  {
    ...
    buttons: [
      { type: "URL", text: "Complete Checkout Now", value: "https://www.clinza.in/cart" }
    ],
    category: "MARKETING",
    updatedAt: new Date().toISOString()
  },
  {
    ...
    buttons: [
      { type: "URL", text: "Write Photo Review", value: "https://www.clinza.in/review/{{Order_Number}}" }
    ],
    category: "MARKETING",
    updatedAt: new Date().toISOString()
  },
  {
    ...
    buttons: [
      { type: "URL", text: "Buy Now Before Sold Out", value: "https://www.clinza.in/product/{{Product_Slug}}" }
    ],
    category: "MARKETING",
    updatedAt: new Date().toISOString()
  },
  {
    ...
    buttons: [
      { type: "URL", text: "Shop Festive Sale", value: "https://www.clinza.in/collections/festive-sale" }
    ],
    category: "MARKETING",
    updatedAt: new Date().toISOString()
  }
...
export const DEFAULT_EMAIL_TEMPLATES: EmailAutomationConfig[] = [
  ...
  <p style="text-align: center;">
    <a href="https://www.clinza.in" style="background: #F27D26; color: #fff; text-decoration: none; font-weight: bold; padding: 14px 28px; border-radius: 6px; display: inline-block;">Explore Collection</a>
  </p>
  ...
  <p><a href="https://www.clinza.in/returns" style="background: #16a34a; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: bold;">Easy Returns & Exchanges</a></p>
</div>`
  },
  {
    id: "review_request",
  ...
  <div style="margin: 30px 0;">
    <a href="https://www.clinza.in/review/{{Order_Number}}" style="background: #f59e0b; color: #000; font-weight: bold; padding: 14px 28px; text-decoration: none; border-radius: 8px;">Leave a Review & Get 200 PTS</a>
  </div>
</div>`
  },
  {
  ...
  <div style="text-align: center; margin: 28px 0;">
    <a href="https://www.clinza.in/cart" style="background: #F27D26; color: #fff; padding: 14px 28px; text-decoration: none; font-weight: bold; border-radius: 6px;">Return to My Cart</a>
  </div>
</div>`
  },
  {
  ...
  <p><a href="https://www.clinza.in/wishlist" style="background: #db2777; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">View Wishlist</a></p>
</div>`
  },
  {
    id: "back_in_stock",
  ...
  <p><a href="https://www.clinza.in/product/{{Product_Slug}}" style="background: #059669; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Order Before It Sells Out</a></p>
</div>`
  },
  {
    id: "birthday_offer",
  ...
  <a href="https://www.clinza.in" style="background: #9333ea; color: #fff; padding: 12px 28px; text-decoration: none; font-weight: bold; border-radius: 6px; display: inline-block;">Claim Birthday Gift</a>
</div>`
  },
  {
    id: "winback_campaign",
  ...
  <p style="text-align: center; margin-top: 24px;">
    <a href="https://www.clinza.in" style="background: #F27D26; color: #fff; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 6px;">Explore What's New</a>
  </p>
</div>`
  }
];
