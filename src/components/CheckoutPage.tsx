...
import { createOrder, calculateCartTotals, getProducts, isComboProduct } from "../utils";
    ...
    setTimeout(() => {
      try {
        const orderItems = cart.map(item => ({
          ...
          name: item.isFreeItem ? `${item.product.name} (FREE GIFT)` : item.product.name,
          price: item.isFreeItem ? 0 : item.product.price,
                  ...
                  <div key={index} className="flex gap-3 py-3 items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        {item.isFreeItem && (
                          <span className="text-[9px] font-black text-emerald-700 bg-emerald-100 px-1.5 py-0.5 rounded uppercase font-mono">
              ...
              <div className="space-y-2.5 pb-4 border-t border-gray-150 pt-4 text-xs font-sans font-medium text-gray-650">
                ...
                {discountAmount > 0 && (
                  <div className="flex justify-between text-emerald-600 font-bold">
                    <span>Discount Savings ({totals.discountPercent}%)</span>
                ...
                <div className="flex justify-between text-gray-900 font-bold">
                  ...
                  {totals.comboPromo?.freeShipping ? (
                ...
                {totals.comboPromo?.freeCOD && (
                  <div className="flex justify-between text-emerald-600 font-bold">
                    <span>Payment Method</span>
                    <span>FREE COD</span>
                  </div>
                )}
                {totals.comboPromo?.freeReturn && (
                  <div className="flex justify-between text-emerald-600 font-bold">
