                      ...
                      <div className="p-5 divide-y divide-gray-100">
                        {order.items.map((it, idx) => (
                          <div key={idx} className="flex items-center gap-4 py-3.5 first:pt-0 last:pb-0 text-xs sm:text-sm">
                            <img 
                              src={it.image ? it.image : "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/slider/combo%20collection%20linen%20set.png"} 
                              alt={it.name}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                  {wishlist.map((prod) => (
                    <div key={prod.id} className="border border-gray-150 rounded-2xl overflow-hidden group bg-white transition hover:shadow-md text-xs relative">
                      <img 
                        src={prod.images ? prod.images[0] : "https://vdtbquxxpikniarmjpai.supabase.co/storage/v1/object/public/products/slider/combo%20collection%20linen%20set.png"} 
                        alt={prod.name}
